    ...
    <section id="submit-idea" className="py-20 bg-gray-900">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white">Share Your Vision</h2>
          <p className="text-gray-400 mt-4 max-w-2xl mx-auto">This is where it all begins. Please fill out the form below to get started.</p>
        </div>
